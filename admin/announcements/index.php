                ...
                <div class="container-fluid p-0">
                    <div class="row mb-2 mb-xl-3">
                        ...
                        <div class="col-auto ml-auto text-right mt-n1">
                            <button class="btn btn-primary" id="btnNewAnnouncement"><i
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            <div class="table-responsive div-table-announcement">
                                <table class="table table-striped table-hover table-announcement"
                                    id="table-announcement" style="width: 100%;">
                                    <thead>
                                        <tr>
                                            <th>Title</th>
                                            <th>Description</th>
