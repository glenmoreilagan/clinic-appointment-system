          ...
          <div class="card mb-3">
            <div class="card-body">
              <div class="table-responsive div-table-health-declaration">
                <table class="nowrap table table-striped table-hover table-health-declaration" id="table-health-declaration" style="width: 100%;">
                  <thead>
                    <tr>
                      <th>Name</th>
                      <th>Address</th>
                      <th>Are you experiencing? (nakakaranas ka ba ng?)</th>
                      <th>Have you had a companion/family member who has symptoms of COVID-19? <br>
                        (Ikaw ba ay may kasama sa bahay na may sintomas ng COVID-19?):</th>
                      <th>Have you had any contact with anyone with COVID-19 symptoms on the past 14 days? <br>
                        (Ikaw ba ay nag-alaga ng pasyente o may nakasalamuha na may COVID-19 o anumang sintomas nito sa nagdaang 14 na araw?):</th>
                      <th>Have you travelled to any area outside Batangas Province on the past 14 days? <br>
                        (Ikaw ba ay nagbyahe sa labas ng Probinsya ng Batangas sa nagdaang 14 na araw?):</th>
                      <th>Date Created: </th>
                    </tr>
                  </thead>
