...
<body>
    ...
    <img src="../image/logo.png"> 
            ...
            <div class="c-login-div"
                style="height: 90vh; display: flex; justify-content: space-evenly; align-items: center;  box-shadow: 0 0.5rem 1rem rgb(0 0 0 / 15%);">
                ...
                <div class="inputs" style="padding: 20px; width: 30em;">
                    ...
                    <div class="form-floating mb-3">
                        <input type="email" class="form-control creds-input" id="floatingInput" name="email"
                            placeholder="name@example.com">
                        <label class="form-label">Email Address:</label>
                    </div>
                    <div class="form-floating">
                        <input type="password" class="form-control creds-input" id="floatingPassword" name="password"
