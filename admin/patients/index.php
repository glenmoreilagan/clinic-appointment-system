...
<script>
  $(document).ready(function() {
            ...
            ready_data.push([
              ...
              `<tr>
                <td>
                  ...
                  <button class="btn btn-primary btn-sm btnPdfDownload" id="r-${res.data[i].id}"><i class="fas fa-fw fa-download"></i> Download</button>
                </td>
              </tr>`,
            ]);
          }
    ...
    $(".table-patients").on("click", ".btnPdfDownload", function(e) {
      e.preventDefault();

      patient_id = $(this).attr('id').split('-')[1];

      window.open(`../functions/download_PDF_per_patient.php?q=${patient_id}`, '_blank');
    });
