...
if ($fname == "" || $lname == "" || $age == "" || $address == "" || $contactnumber == "" || $email == "" || $password == "" || $cpassword == "") {
...
if ($password == $cpassword) {
  ...
  if ($result->num_rows == 0) {
    $sql = "INSERT INTO tbl_user (fname, mname, lname, fullname, age, address, contactno, email, password, email_verification)
			VALUES ('$fname', '$mname', '$lname', '$fullname', '$age', '$address', '$contactnumber', '$email', '$password', '$code')";
    $result = mysqli_query($conn, $sql);
    if ($result) {
      $email_message = "
