...
<body data-theme="default" data-layout="fluid" data-sidebar-position="left" data-sidebar-behavior="sticky">
                        ...
                        <div class="card-body">
                            ...
                            <div class="feedback mb-3">
                                ...
                                <textarea class="form-control" name="feedback" id="feedback"
                                    placeholder="Input your feedback"></textarea>
                            </div>
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            <div class="table-responsive div-table-feedback">
                                <table class="table table-striped table-hover table-feedback" id="table-feedback"
                                    style="width: 100%;">
                                    <thead>
                                        <tr>
                                            <th>Rating</th>
    ...
    $(document).ready(function() {
        ...
        const delete_feedback = (feedback_id) => {
            $.ajax({
                method: 'POST',
                url: '../functions/delete_feedback.php',
                dataType: 'JSON',
                data: {
        ...
        $(".table-feedback").on("click", ".btnDelete", function(e) {
            e.preventDefault();

            feedback_id = $(this).attr('id').split('-')[1];
